...
Future<bool> saveUserLongitude(String getUserLongitude)async{
  SharedPreferences prefs= await SharedPreferences.getInstance();
  return prefs.setString(longitudeKey, getUserLongitude);
}


Future<bool> saveUserLatitude(String getUserLatitudeKey)async{
  SharedPreferences prefs= await SharedPreferences.getInstance();
  return prefs.setString(latitudeKey, getUserLatitudeKey);
}

Future<bool> saveUserNumber(String getUserNumber)async{
  SharedPreferences prefs= await SharedPreferences.getInstance();
  return prefs.setString(number, getUserNumber);
}
